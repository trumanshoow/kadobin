...
import PhoneNote from '../../assets/icons/telephon'
            ...
            <div className={Styles.whiteSection}>
                <div className={Styles.container}>
                    ...
                    <div className={Styles.parentInput}>
                        <button className={Styles.button}><PhoneNote className={Styles.Telephone}/></button>
                        <Input className={Styles.Input2} type={Number} placeholder=" -  -  -  -  -  -  -  -  -  - 09 "/>
                    </div>
