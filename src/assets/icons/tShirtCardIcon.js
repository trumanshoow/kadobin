    ...
    <>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32.108 32.108" {...props}>
        <g id="icons8_t-shirt" transform="translate(-3 -3)">
          ...
          <path id="Path_1470" dataName="Path 1470" d="M21.189,8.189,18,5V17.486h1.784a3.567,3.567,0,0,0,3.568-3.568v-.51A7.383,7.383,0,0,0,21.189,8.189Z" transform="translate(11.757 1.568)" fill="#7ba1fb" />
          <path id="Path_1471" dataName="Path 1471" d="M5.162,8.189,8.351,5V17.486H6.568A3.567,3.567,0,0,1,3,13.919v-.51A7.383,7.383,0,0,1,5.162,8.189Z" transform="translate(0 1.568)" fill="#7ba1fb" />
        </g>
      </svg></>
  )
}
